...
$3Dmol.GLModel = (function() {
    ...
    */
    ...
    function GLModel(mid, options) {
        ...
        //var getElemMass = function(atom){
        //    var m = atomMasses[atom.elem];
        //    return m;
        //};
        ...
        this.getConnData = function() {
            if (modelData.conns) {
                return [modelData.cindex, modelData.conns, modelData.rotType, modelData.specRot, modelData.conntypes];
            }
            else {
                return null;
            }
